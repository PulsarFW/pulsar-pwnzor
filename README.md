...
# PULSAR-PWNZOR
**Anti-cheat and exploit detection system for Pulsar Framework**
...
Client and server-side protection system detecting cheats, exploits, and unauthorized modifications. Configurable detection thresholds and automated response actions via `cl_config.lua` and `sv_config.lua`.
